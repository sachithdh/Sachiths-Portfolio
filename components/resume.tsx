...
export function Resume() {
  const experiences = [
    {
      ...
      company: "Xeptagon",
      location: "Port City, SL",
      period: "Nov 2025 - Present",
      description: [
        // "Built scalable software for global clients, enhancing performance.",
        // "Worked with PMs and cross-functional teams to meet business goals.",
        // "Identified and resolved critical bottlenecks efficiently.",
        // "Delivered high-quality products on tight deadlines.",
      ],
      color: "bg-primary/20",
  ...
  return (
    <section className="max-h-screen p-6 md:p-12 relative overflow-hidden">
      <div
