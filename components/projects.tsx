...
const projects = [
  {
    title: "LearnHub",
    description: "A platform that connects students with independent tutors in a smarter, more personalized way.",
    tags: ["PHP", "JavaScript", "MySQL"],
    image: "/images/learnhub.png",
    github: "https://github.com/sachithdh/LearnHub",
    rotation: "rotate-[1deg]",
    featured: true,
  },
  {
    title: "brainMap",
    description: "A comprehensive web platform that connects project members with mentors for collaborative project management and guidance.",
    tags: ["SpringBoot", "TypeScript", "Next.js", "Tailwind", "PostgreSQL", "Supabase"],
    image: "/images/brainMap.png",
    github: "https://github.com/orgs/brain-Map/repositories",
    rotation: "rotate-[-2deg]",
    featured: true,
  },
  {
    title: "Eventer",
    description: "A university event management platform that enables students and administrators to create, discover, and manage campus events",
  ...
  },
  {
    ...
    description: "A platform showcasing how modern middleware addresses real-world integration challenges.",
    tags: ["Java", "TypeScript", "Python", "JavaScript"],
    image: "/images/swift.png",
    github: "https://github.com/orgs/SwiftLogistics-co/repositories",
    rotation: "rotate-[-1deg]",
    featured: false,
  },
]
